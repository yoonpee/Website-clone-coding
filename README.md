...
<h4> * 프로젝트를 하면서 </h4>
 -멀티페이지 웹사이트를 만들며, CSS 최신기법인 Display Flex  Grid를 공부하고 적용하였으며, Sass를 이용해 스타일링 하는 방법과 코드를 재 활용하는 방법들을 배우고 되었고 반응형 사이트는 어떻게 만들수있는지 또한 flex wrap 을 이용하여 손쉽게 반응형 효과를 낼수있는 방법도 배웠습니다.
